...
export const TasksCount = styled.div<{ glow: boolean }>`
  ...
  /* background: #090b2258; */
  background: ${({ theme }) =>
    getFontColor(theme.secondary) === ColorPalette.fontLight ? "#09221c" : "#ffffff3e"};
  transition: 0.3s all;
  display: flex;
  align-items: center;
  ...
  border: 1px solid
    ${({ theme }) =>
      getFontColor(theme.primary) === ColorPalette.fontLight ? "#069696" : "#069696"};
...
export const ProgressPercentageContainer = styled(Box)<{ glow: boolean }>`
  ...
  /* background: #090b2287; */
  background: ${({ theme }) =>
    getFontColor(theme.secondary) === ColorPalette.fontLight ? "#09221c" : "#ffffff5c"};

  border-radius: 100px;
  margin: -5px;
  border: 1px solid
    ${({ theme }) =>
      getFontColor(theme.secondary) === ColorPalette.fontLight ? theme.primary : theme.primary};
  box-shadow: ${({ theme }) =>
    `0 0 18px -2px ${
